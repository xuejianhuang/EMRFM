...
def run(args, debug_args=None):
   ...
   # args.model_output_path = 'outputs\\misa_MIntRec_multi-class_2022-11-03-18-43-25\\models'
...
def set_args(models, args):
    ...
    if models == "text_bert":
        args.method = 'text'
        args.config_file_name = 'text_bert'
        args.results_file_name = 'text_bert.csv'
    elif models == "text_bert_bi":
        args.method = 'text'
        args.data_mode = 'binary-class'
        args.config_file_name = 'text_bert_bi'
        args.results_file_name = 'text_bert_bi.csv'
    elif models == "mag_bert":
        args.method = 'mag_bert'
        args.config_file_name = 'mag_bert'
        args.results_file_name = 'mag_bert.csv'
    elif models == "mag_bert_bi":
        args.method = 'mag_bert'
        args.data_mode = 'binary-class'
        args.config_file_name = 'mag_bert_bi'
        args.results_file_name = 'mag_bert_bi.csv'
    elif models == "misa_bert":
        args.method = 'misa'
        args.config_file_name = 'misa_bert'
        args.results_file_name = 'misa_bert.csv'
    elif models=="misa_bert_bi":
        args.method = 'misa'
        args.data_mode = 'binary-class'
        args.config_file_name = 'misa_bert_bi'
        args.results_file_name = 'misa_bert_bi.csv'
    elif models == "mult_bert":
        args.method = 'mult'
        args.config_file_name = 'mult_bert'
        args.results_file_name = 'mult_bert.csv'
    elif models == "mult_bert_bi":
        args.method = 'mult'
        args.data_mode = 'binary-class'
        args.config_file_name = 'mult_bert_bi'
        args.results_file_name = 'mult_bert_bi.csv'
    elif models == "nmfir_bert":
        args.method = 'nmfir'
        args.config_file_name = 'nmfir_bert'
        args.results_file_name = 'nmfir_bert.csv'
    elif models == "nmfir_bert_bi":
        args.method = 'nmfir'
        args.data_mode = 'binary-class'
        args.config_file_name = 'nmfir_bert_bi'
        args.results_file_name = 'nmfir_bert_bi.csv'
    elif models == "baseline_bert":
        args.method = 'baseline'
        args.config_file_name = 'baseline_bert'
        args.results_file_name = 'baseline_bert.csv'
    elif models == "baseline_bert_bi":
        args.method = 'baseline'
        args.data_mode = 'binary-class'
        args.config_file_name = 'baseline_bert_bi'
        args.results_file_name = 'baseline_bert_bi.csv'
if __name__ == '__main__':

    warnings.filterwarnings('ignore')

    args = parse_arguments()
    set_args("nmfir_bert", args)  # hxj
    print(args)  # hxj
    param = ParamManager(args)   #add common_param and hyper_param
    args = param.args
