...
class DataManager:
    ...
    def _get_multimodal_data(self, args):
        ...
        #133 267 400 534 667 800 934 1067 1200 1334
        end=1334
        ids=self.train_label_ids
        ids,t_data,v_data,a_data=sklearn.utils.shuffle(ids,text_data['train'], video_data['train'],audio_data['train'], random_state=0)
        mm_train_data = MMDataset(ids[:end], t_data[:end], v_data[:end], a_data[:end])
